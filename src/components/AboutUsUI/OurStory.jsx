...
const OurStory = () => {
  return (
    <div className="  ">
      ...
      {/*-------------------------- containers  1st-----------------------*/}
      <div className="flex flex-col md:flex-row items-center relative mt-12 md:mt-24">
        {/* Text Card */}
        <div
          className="flex flex-col justify-center  bg-white w-[80%] -mt-20 md:mt-0 md:w-1/2 h-auto md:h-80 z-10 p-6 md:p-6 shadow-lg 
     ...
     <div className="flex flex-col md:flex-row items-center relative mt-12 md:mt-24">
        {/* Text Card */}
        <div
          className="flex flex-col justify-center bg-white w-[80%] md:w-1/2 -mt-20 md:mt-0 h-auto md:h-80 z-10 p-6 md:p-6 shadow-lg 
                  md:-mr-24 lg:-mr-30 md:ml-16 order-2 md:order-1 text-right"
        >
          <div className="flex items-center justify-end mb-4 gap-1">
            <hr className="border-2 w-8 md:w-10 border-[#4c1d29]/50" />
