...
const OurHistory = () => {
  ...
  <div className="w-full lg:w-[60%] text-center">
    ...
    <div className="my-6 lg:my-9">
      <h2 className="text-5xl sm:text-6xl lg:text-[6rem] text-gray-300 tracking-[0.1rem] mb-0 leading-none opacity-70">
        ABOUT US
      </h2>

      <h3 className="text-3xl sm:text-4xl lg:text-4xl font-bold text-[#4c1d29] -mt-10 sm:-mt-12 lg:-mt-16 mb-10 lg:mb-14 relative">
    ...
    <div className="flex flex-col justify-center items-center gap-8 lg:gap-12">
      <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 text-center p-3 font-paragraph leading-relaxed">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam,
        tempora. Lorem ipsum dolor sit amet <br className="hidden sm:block" />
